...
class ControllerLapPMB extends CI_Controller {
	...
	public function cetak()
	{
		...
		$query = $this->db->query("SELECT * FROM calon_siswa JOIN pendaftaran ON calon_siswa.id_calon_siswa = pendaftaran.id_calon_siswa WHERE thn_ajar =  '$tahun_ajaran'")->result();
        ...
        $fileName = 'DATA_PMB_'.$tahun_ajaran.'_.pdf';
