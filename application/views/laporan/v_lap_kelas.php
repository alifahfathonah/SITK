		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					...
					<a href="<?php echo site_url('laporan_kelas') ?>">Laporan Data Kelas</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
					...
					<div class="portlet-body flip-scroll">
						<div class="portlet light">
							<div class="portlet-body form">
								<form method="POST" action="<?php echo site_url('laporan_kelas/cetak') ?>">
									<div class="form-body">
										...
										<div class="row">
											<div class="col-md-5">
												<div class="form-group form-md-line-input has-info">
													<select name="kelas" class="form-control" id="form_control_1">
														<?php foreach($kelas as $kls){ ?>
															<option value="<?php echo $kls->id_kelas ?>"><?php echo $kls->nm_kelas ?></option>
														<?php } ?>
													</select>
